module.exports = function( grunt ) 
{
    var und             = grunt.util._,
        ...
        parse           = function( modules  )
        {
            ...
            grunt.file.write( '/Users/ruben.lopez/Enviroment/deploy/ueWidgets/dist/ue-script.sublime-completions', JSON.stringify({ scope : scope, completions : completions }, null, 4 ) )
        };
