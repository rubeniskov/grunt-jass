module.exports = function( grunt ) 
{
    var defaults        = 
        ...
        build           = function( options )
        {
            var modules         = [],
                ...
                ({ 
                    ...
                    paths       :[ '/Users/ruben.lopez/Enviroment/deploy/ueScript/src' ]
        ...
        {
            var twigTemplate    = grunt.file.read( '/Users/ruben.lopez/Enviroment/deploy/ueScript/doc/doc-template.md', { encoding : 'UTF-8' });
